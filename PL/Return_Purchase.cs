...
namespace sales_management.PL
{
    class Return_Purchase
    {
        public DataSet Get_Purchase_Invoice_Data_Set( ) {
            ...
            DAL.Open();
            ds = DAL.SelectDataSet("Get_Return_Purchase_Invoice_Data_Set", param );
            DAL.Close();
        ...
        public DataTable Create_Purchase_Invoice_Id() {
            ...
            DAL.Open();
            table = DAL.SelectData("Create_Return_Purchase_Invoice_Id", null);
            DAL.Close();
        ...
        public DataTable Get_All_Purchase_Invoices() {
            ...
            DAL.Open();
            table = DAL.SelectData("Get_All_Return_Purchase_Invoices", null );
            DAL.Close();
            ...
            )
        {
            ...
            DAL.Open();
            DAL.ExecuteCommand("Update_Return_Purchase_Invoice_Data_Set", param);
            DAL.Open();
        }
        ...
        public void Save_Updates_Invoice_Data(
            ...
            DAL.Open();
            DAL.ExecuteCommand("Save_Updates_Invoice_Data_Return_Purchase", param);
            DAL.Open();
