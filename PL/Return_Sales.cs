...
namespace sales_management.PL
{
    class Return_Sales
    {
        public DataSet Get_Sale_Invoice_Data_Set( ) {
            ...
            DAL.Open();
            ds = DAL.SelectDataSet("Get_Return_Sales_Invoice_Data_Set", param );
            DAL.Close();
        ...
        public DataTable Create_Sale_Invoice_Id() {
            ...
            DAL.Open();
            table = DAL.SelectData("Create_Return_Sales_Invoice_Id", null);
            DAL.Close();
        ...
        public DataTable Get_All_Sale_Invoices() {
            ...
            DAL.Open();
            table = DAL.SelectData("Get_All_Return_Sales_Invoices", null );
            DAL.Close();
            ...
            )
        {
            ...
            DAL.Open();
            DAL.ExecuteCommand("Update_Return_Sales_Invoice_Data_Set", param);
            DAL.Open();
        }
        ...
        public void Save_Updates_Invoice_Data(
            ...
            DAL.Open();
            DAL.ExecuteCommand("Save_Updates_Invoice_Data_Return_Sale", param);
            DAL.Open();
