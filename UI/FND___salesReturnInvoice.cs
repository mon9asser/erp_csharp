    ...
    public partial class FND___salesReturnInvoice : Form
    {
        ...
        public void Load_Target_Accounts(int paymentType)
        {
            ...
            try
            {
                ...
                {
                    // Deferred payment
                    account = Get_Account_Details(this.Settings.Rows[0]["customers_account"].ToString());
            ...
            try {
                ...
                */
                ...
                if (enable_zakat_taxes.Checked)
                {
                    ...
                    salesRow_vat_to["description"] = "ض.ق.م مردود مبيعات";
                ...
                salesRow_cost_goods_to["description"] = "مرتجعات فاتورةى مبيعات علي المخزون";
