...
{
    public partial class salesReturnInvoice : Form
    {
        // New Updates 
        ...
        public static salesReturnInvoice frm;
        ...
        public static salesReturnInvoice GetForm
        {
            get
            {
        ...
        public void Load_deletion_icon_in_datagridview()
        {
            ...
            //UI.salesReturnInvoice.GetForm.items_datagridview.Rows[e.RowIndex].Cells["deletion_et_button"].Value = Properties.Resources.delete_16;

            // for (int i = 0; i < UI.salesReturnInvoice.GetForm.items_datagridview.Rows.Count; i++) {
            //    UI.salesReturnInvoice.GetForm.items_datagridview.Rows[i].Cells["deletion_et_button"].Value = Properties.Resources.icons8_delete_20;
            //}
        ...
        private void Store_Invoice_Data()
        {
            ...
            */
            ...
            salesRow_sales_to["debit"] = enable_zakat_taxes.Checked ? total_without_vat_field.Text : total_field_text.Text;
            ...
            salesRow_cost_goods_to["debit"] = cost_total.ToString();
            ...
            salesRow_cost_goods["credit"] = cost_total.ToString();
